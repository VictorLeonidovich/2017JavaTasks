...
public class Solution {
    ...
    public synchronized String getPartOfString(String string, String threadName) {
        ...
        try{
            ...
            if (threadName.equals(Solution.FIRST_THREAD_NAME)) {throw new TooShortStringFirstThreadException();} else
            if (threadName.equals(Solution.SECOND_THREAD_NAME)){throw new TooShortStringSecondThreadException();} else
